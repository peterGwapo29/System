                    ...
                    <form id="registerEventForm" class="w-full">
                        ...
                        <div class="flex items-center justify-end gap-3 mt-8">
                            ...
                            <button id="registerEventBtn" type="submit"
                                class="px-4 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 font-medium inline-flex items-center transition-colors duration-200">
                                <svg style="color: white;" class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
